...
def create_order(request: dict, repo: OrderRepository = Depends(get_order_repository), warehouse_client: WarehouseServiceClient = Depends(get_warehouse_service_client), publisher: Publisher = Depends(get_publisher)):
...
def get_order(order_id: str, repo: OrderRepository = Depends(get_order_repository)):
...
def update_order(order_id: str, update: OrderUpdate, repo: OrderRepository = Depends(get_order_repository)):
...
def delete_order(order_id: str, repo: OrderRepository = Depends(get_order_repository)):
...
def assign_vehicle(order_id: str, data: dict, repo: OrderRepository = Depends(get_order_repository), fleet_client: FleetServiceClient = Depends(get_fleet_service_client), warehouse_client: WarehouseServiceClient = Depends(get_warehouse_service_client), publisher: Publisher = Depends(get_publisher)):
...
def change_status(order_id: str, data: dict, repo: OrderRepository = Depends(get_order_repository), warehouse_client: WarehouseServiceClient = Depends(get_warehouse_service_client), publisher: Publisher = Depends(get_publisher)):
...
def complete_delivery(order_id: str, data: dict = None, repo: OrderRepository = Depends(get_order_repository), warehouse_client: WarehouseServiceClient = Depends(get_warehouse_service_client), publisher: Publisher = Depends(get_publisher)):
    use_case = ChangeOrderStatusUseCase(repo, warehouse_client, publisher)
...
def cancel_order(order_id: str, repo: OrderRepository = Depends(get_order_repository), publisher: Publisher = Depends(get_publisher)):
